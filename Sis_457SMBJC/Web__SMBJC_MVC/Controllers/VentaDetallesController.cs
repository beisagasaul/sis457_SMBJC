...
namespace Web__SMBJC_MVC.Controllers
{
    public class VentaDetallesController : Controller
    {
        ...
        public VentaDetallesController(LabSmbjcContext context)
        {
            _context = context;
        }
        ...
        {
            var labSmbjcContext = _context.VentaDetalles.Include(v => v.IdProductoNavigation).Include(v => v.IdVentaNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabSmbjcContext.VentaDetalles'  is null.");
            }
            var ventaDetalle = await _context.VentaDetalles.FindAsync(id);
            if (ventaDetalle != null)
            {
