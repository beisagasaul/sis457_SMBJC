...
namespace Web__SMBJC_MVC.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(LabSmbjcContext context)
        {
            _context = context;
        }
        ...
        {
            var labSmbjcContext = _context.Productos.Include(p => p.IdCategoriaNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdProducto,IdCategoria,Codigo,Nombre,Descripcion,Precio,UsuarioRegistro,FechaRegistro,Estado")] Producto producto)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabSmbjcContext.Productos'  is null.");
            }
            var producto = await _context.Productos.FindAsync(id);
            if (producto != null)
            {
