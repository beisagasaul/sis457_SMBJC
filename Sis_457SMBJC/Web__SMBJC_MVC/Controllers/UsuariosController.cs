...
namespace Web__SMBJC_MVC.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(LabSmbjcContext context)
        {
            _context = context;
        }
        ...
        {
            var labSmbjcContext = _context.Usuarios.Include(u => u.IdEmpleadoNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabSmbjcContext.Usuarios'  is null.");
            }
            var usuario = await _context.Usuarios.FindAsync(id);
            if (usuario != null)
            {
