...
namespace Web__SMBJC_MVC.Controllers
{
    ...
    public class EmpleadosController : Controller
    {
        ...
        public EmpleadosController(LabSmbjcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empleados != null ? 
                          ...
                          Problem("Entity set 'LabSmbjcContext.Empleados'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabSmbjcContext.Empleados'  is null.");
            }
            var empleado = await _context.Empleados.FindAsync(id);
            if (empleado != null)
            {
