...
public partial class LabSMBJCEntities : DbContext
{
    public LabSMBJCEntities()
        : base("name=LabSMBJCEntities")
    {
    ...
    public virtual ObjectResult<paCompraoListar_Result> paCompraoListar(string parametro)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paCompraoListar_Result>("paCompraoListar", parametroParameter);
    }


    public virtual ObjectResult<paDcompraoListar_Result> paDcompraoListar(string parametro)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paDcompraoListar_Result>("paDcompraoListar", parametroParameter);
    }


    public virtual ObjectResult<paDventaListar_Result> paDventaListar(string parametro)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<paDventaListar_Result>("paDventaListar", parametroParameter);
    }
